 ...
 */
public class R300ConversionScalarToPrimTests extends RTestBase {
        ...
        for (JavaPrimitive primSrc : JavaPrimitive.values()) {
            ...
            for (JavaPrimitive primDest : JavaPrimitive.values()) {
                ...
                if (lines.size() == 2) {
                    ...
                    String s2 = JavaPrimitive.getGetValueStr(primDest);
...
//                    }
                    String line1 = String.format("%s tmp1 = src.%s;", srcTypeStr, srcField);
                    String line2 = String.format("%s tmp2 = tmp1.%s();", destTypeStr, s2);
