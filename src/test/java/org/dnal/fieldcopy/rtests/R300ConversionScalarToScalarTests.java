 ...
 */
public class R300ConversionScalarToScalarTests extends RTestBase {
    ...
    public void testAll() {
        ...
        for (JavaPrimitive primSrc : JavaPrimitive.values()) {
            ...
            String srcTypeStr = JavaPrimitive.getScalarType(primSrc);
            ...
            for (JavaPrimitive primDest : JavaPrimitive.values()) {
                ...
                if (lines.size() == 2) {
                    ...
                    String lowStr = JavaPrimitive.getGetValueStr(primDest);
                    String line1 = String.format("%s tmp1 = src.%s;", srcTypeStr, srcField);
                    String line2 = String.format("%s tmp2 = tmp1.%s();", destTypeStr, lowStr);
    ...
    public void testByte() {
        ...
        String[] ar5 = {
                ...
                "Byte tmp2 = Byte.valueOf(tmp1.charValue());",
                "dest._byte = tmp2;"
        };
    ...
    public void testChar() {
        ...
        String[] ar = {
                "Integer tmp1 = src._int;",
                "Character tmp2 = Character.valueOf((char)tmp1.intValue());",
                "dest._char = tmp2;"};
        runAndChk("_int", destField, ar);
    ...
    private CopySpec buildOneField(String src, String dest) {
        return buildWithField(AllScalars1.class, AllScalars1.class, src, dest);
    }
