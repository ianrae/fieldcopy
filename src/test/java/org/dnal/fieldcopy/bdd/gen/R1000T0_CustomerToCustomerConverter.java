...
public class R1000T0_CustomerToCustomerConverter implements ObjectConverter<Customer, Customer> {
  ...
  public Customer convert(Customer src, Customer dest, ConverterContext ctx) {
    ...
    if (tmp2 != null) {
    ObjectConverter<Address,Address> conv3 = ctx.locate(Address.class, Address.class, "conv1");
