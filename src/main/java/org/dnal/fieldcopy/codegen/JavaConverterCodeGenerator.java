...
public class JavaConverterCodeGenerator {
    ...
    public JavaConverterCodeGenerator(FieldCopyOptions options, String dir) {
    ...
    public List<String> genJavaSource(String packageName, String className, CopySpec spec,
        ...
        int indent = 0;
        if (options.outputGeneratedByCommentFlag) {
            sc.o("// ****** This code was generated by the FieldCopy code generation library. *****");
        }
